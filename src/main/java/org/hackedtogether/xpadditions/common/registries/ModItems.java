...
public class ModItems {
    ...
    public static final RegistryObject<Item> XP_FIREWORK_ROCKET = ModItemRegister.register("xp_firework_rocket", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MISC)));
